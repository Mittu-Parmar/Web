          ...
          <div class="col-12 grid-margin">
            <div class="card">
              <div class="card-body">
                ...
                <form class="form-sample" action="DeleteUser" method="get">
                  <p class="card-description">
                  <%  HttpSession se=request.getSession();
                  String s=request.getParameter("RFID"); %>
                    Are you sure you want to delete user with RFID <%=request.getParameter("RFID")%>?
                    <% se.setAttribute("RFID",s); %>
                  </p>
