      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="page-header">
            ...
            if(ses1.getAttribute("updatebook")!=null)
			{
            %>
            <h3 class="page-title" style="color:green">
              
              <%=ses1.getAttribute("updatebook") %>
              <%ses1.invalidate(); %>
            </h3>
            <%
			}
            ...
            if(ses2.getAttribute("deletebook")!=null)
			{
            %>
            <h3 class="page-title" style="color:green">
              
              <%=ses2.getAttribute("deletebook") %>
              <%ses2.invalidate(); %>
            </h3>
            <%
			}
			...
			if(ses3.getAttribute("addbook")!=null)
			{
            %>
            <h3 class="page-title" style="color:green">
              
              <%=ses3.getAttribute("addbook") %>
              <% ses3.invalidate(); %>
            </h3>
            <%
			}
...
<%
	...
	if(rs.next())
	{
		...
		do{
			...
			out.println("</td>");
			out.println("<td>");
			out.println("<a href=DeleteBook.jsp?BookIsbn="+BookIsbn+">DELETE</a>");
			out.println("</td>");
			out.println("<td>");
			out.println("<a href=UpdateBook.jsp?BookIsbn="+BookIsbn+">UPDATE</a>");
			out.println("</td>");
			out.println("</tr>");
