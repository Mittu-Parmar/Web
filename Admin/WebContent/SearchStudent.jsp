...
<strong>SEARCH BY STUDENT ENROLLMENT</strong><br>
<form action="">
...
try{
	...
	ResultSet rs=s.executeQuery("select RFID,Enrollment from user");
	while(rs.next())
	{
%>
	<option value="<%=rs.getString("RFID")%>"
	<%
		if(request.getParameter("cmbBook")!=null)
		{
			if(rs.getString("RFID")==request.getParameter("cmbBook"))
			{
		...
		><%=rs.getString("Enrollment")%></option>
...
try{
	...
	ResultSet rs=s.executeQuery("select * from user where RFID='"+str+"'");
	while(rs.next())
	{
	%>
                ...
                <form class="form-sample" action="AddBooks" method="get">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="BookTitle" value="<%=rs.getString("Name") %>" readonly/>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="BookIsbn" value="<%=rs.getString("Email") %>" readonly/>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input class="form-control" type="text" name="BookAuthor"   value="<%=rs.getString("RFID") %>" readonly/>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="BookPublisher" value="<%=rs.getString("Department") %>" readonly/>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="BookPrice" value="<%=rs.getString("Gender") %>" readonly/>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="NoOfBooks" value="null" readonly/>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="Category" value="<%=rs.getString("Enrollment") %>" readonly/>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="Image" value="<%=rs.getString("Contact") %>" readonly/>
                        </div>
                      </div>
                    </div>
                  </div>
