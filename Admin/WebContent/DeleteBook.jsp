          ...
          <div class="col-12 grid-margin">
            <div class="card">
              <div class="card-body">
                ...
                <form class="form-sample" action="DeleteBook" method="get">
                  <p class="card-description">
                  	<%  HttpSession se=request.getSession();
                  String s=request.getParameter("BookIsbn"); %>
                    Are you sure you want to delete book with isbn <%=request.getParameter("BookIsbn")%>?
                    <% se.setAttribute("BookIsbn",s); %>
                  </p>
                  
                    
                  
                  <input type="submit" class="btn btn-gradient-primary mr-2" value="Yes" />
