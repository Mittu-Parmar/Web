      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="page-header">
			...
			if(ses1.getAttribute("updateuser")!=null)
			{
            %>
            <h3 class="page-title" style="color:green">
              
              <%=ses1.getAttribute("updateuser") %>
              <% ses1.invalidate(); %>
            </h3>
            <%
			}
			...
			if(ses2.getAttribute("deleteuser")!=null)
			{
            %>
            <h3 class="page-title" style="color:green">
              
              <%=ses2.getAttribute("deleteuser") %>
              <% ses2.invalidate(); %>
            </h3>
            <%
			}
			...
			if(ses3.getAttribute("addstudent")!=null)
			{
            %>
            <h3 class="page-title" style="color:green">
              
              <%=ses3.getAttribute("addstudent") %>
              <% ses3.invalidate(); %>
            </h3>
            <%
			}
...
try{
	...
	if(rs.next())
	{
		...
		do{
			...
			out.println("</td>");
			out.println("<td>");
			out.println("<a href=DeleteUser.jsp?RFID="+RFID+">DELETE</a>");
			out.println("</td>");
			out.println("<td>");
			out.println("<a href=UpdateUser.jsp?RFID="+RFID+">UPDATE</a>");
			out.println("</td>");
			out.println("</tr>");
